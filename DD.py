...
# Heading
w2 = Label(root, justify=LEFT, text="Drug Disease Prediction using Machine Learning", fg="white", bg="blue")
...
log = Label(root, text="LogisticRegression", fg="white", bg="red")
log.grid(row=15, column=0, pady=10, sticky=W)

svc = Label(root, text="SupportVectorMachine", fg="white", bg="red")
